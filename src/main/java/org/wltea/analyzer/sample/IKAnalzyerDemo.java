...
public class IKAnalzyerDemo {
    ...
    public static void test1() {
        ...
        TokenStream ts = null;
        try {//这是一个中文分词的例子，你可以直接运行它！IKAnalyer can analysis english text too
            ts = analyzer.tokenStream("myfield", new StringReader("题"));
            //获取词元位置属性
    ...
    public static void test3() {
       ...
       /* Integer[]delete={32};
        List<Integer> deleteList = Arrays.asList(delete);
